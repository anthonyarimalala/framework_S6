<template>
	...
	<div className="mb-3"> 
        ...
        <div class="row">
			...
			<th> Token </th>
                ...
                <tbody>
                    <tr v-for="item in passwordResets" :key="item.email">
	...
	<div className="mb-3"> 
	 	...
	 	<input className="form-control" type="hidden" name="email" />
	</div>
	<div className="mb-3"> 
	 	<label className="form-label">Token</label> 
	 	<input className="form-control" type="text" name="token" />
    ...
    export default{
        ...
        methods: {
            async getAll() {
                /*try {
                    this.loading = true;
                    const response = await fetch(this.url + 'passwordResets');
                    if (!response.ok) {
                ...
                try{
                    	fetch(this.url + 'password_resets') 
	 .then(response => response.json()) 
	.then(data => { this.password_resets = data; }) 
